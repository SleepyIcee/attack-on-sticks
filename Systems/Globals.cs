...
public static class Globals
{
    ...
    public const int GROUND_LEVEL = VERTUAL_SCREEN_HEIGHT - 200;
    ...
    public static int maxColorValue = 255;

    // player settings
    public const int PLAYER_WIDTH = 64;
    public const int PLAYER_HEIGHT = 64;
    public static readonly Vector2 OriginPlayerPos = new Vector2(VERTUAL_SCREEN_WIDTH / 2, GROUND_LEVEL - PLAYER_HEIGHT);
